...
module.exports = {
  ...
  findAllUsers: (req, res) => {
    User.find()
      ...
      .catch((err) =>
        res.json({
          message: "Something went wrong in findAllUsers",
          error: err,
        })
      );
  },
  ...
  updateUser: (req, res) => {
    User.findOneAndUpdate({ _id: req.params.id }, req.body, { new: true })
      ...
      .catch((err) =>
        res.json({ message: "Something went wrong in updateUser", error: err })
      );
  },
  ...
  deleteUser: (req, res) => {
    User.deleteOne({ _id: req.params.id })
      ...
      .catch((err) =>
        res.json({ message: "Something went wrong in deleteUser", error: err })
      );
  },
};
